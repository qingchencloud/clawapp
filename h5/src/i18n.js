...
const messages = {
  'zh-CN': {
    ...
    'setup.tips.toggle': '如何获取这些信息？',
    'setup.tips.host.title': '服务器地址',
    'setup.tips.host.desc': 'ClawApp 服务启动后显示的地址，默认为 电脑IP:3210。手机和电脑需在同一 WiFi 下。',
    'setup.tips.token.title': 'Token',
    'setup.tips.token.desc': '即 server/.env 中的 PROXY_TOKEN，安装时设置的客户端连接密码。',
    'setup.tips.doc': '详细文档',
    // 聊天页
  ...
  'en': {
    ...
    'setup.tips.toggle': 'How to get this info?',
    'setup.tips.host.title': 'Server Address',
    'setup.tips.host.desc': 'The address shown when ClawApp server starts, default is YourIP:3210. Phone and PC must be on the same WiFi.',
    'setup.tips.token.title': 'Token',
    'setup.tips.token.desc': 'The PROXY_TOKEN in server/.env, set during installation as client password.',
    'setup.tips.doc': 'Documentation',
